...
Meu nome é Iury Gomes de Oliveira, e sou Professor no Instituto Federal do Tocantins - IFTO. Desenvolvedor com perfil Full Stack, tenho bacharelado em Ciência da Computação, Pós-graduação em Gestão de TI, sou amante de boas práticas de desenvolvimento. Sei trabalhar com HTML, CSS, JAVASCRIPT, jQuery, NodeJS, PHP, Python, MongoDB e MYSQL. Mestrando em Ciência da Computação na UFBA. Seguidor de Cristo, Marido da Lívia, Pai da Talita e da Helena
